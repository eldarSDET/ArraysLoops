...
public class basicArrayList {
	public static void main(String[] args) {
		ArrayList bankCards=new ArrayList();//ArrayList is a class
		bankCards.add("Visa");
		bankCards.add("Master Card");
		...
		System.out.println("-----------------------------");
		for(int index=0; index<bankCards.size(); index++) {
			System.out.println(bankCards.get(index));
